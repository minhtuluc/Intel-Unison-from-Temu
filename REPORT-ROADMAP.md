...
Tám mục `done (M2)` ở trên (UT-004, UT-006, UT-007, UT-008, UT-009, UT-013, UT-014, UT-017) đã hoàn tất thi công và kiểm thử hồi quy 100% trên nhánh `m2-phase1-transport` (259 tests pass, quality gate sạch).
...
| M2 — Truyền file tin cậy  | UT-004, UT-006–009, UT-013–014, UT-017 — đã hoàn thành thi công trên nhánh `m2-phase1-transport`.                              | Hoàn thành: 259/259 tests pass; batch upload không kẹt queue; atomic collision; temp sweep; resume session reconcile; RFC 9110 Range; Windows reserved name sanitize; error handler mapping. |
