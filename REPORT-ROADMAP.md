...
Các mục M2 (UT-004, UT-006, UT-007, UT-008, UT-009, UT-013, UT-014, UT-017) đang được cập nhật và bổ sung regression suite giải quyết toàn bộ 10 điểm yêu cầu thay đổi (R1–R10) từ QC review (`REVIEW-M2.md` vòng 1 và vòng 2).
...
| M2 — Truyền file tin cậy  | UT-004, UT-006–009, UT-013–014, UT-017 — đang xử lý QC review R1–R10 trên nhánh `m2-reliable-transfer`.                        | Giải quyết triệt để R1–R4 (vòng 1) và R5–R10 (vòng 2: incremental SHA-256 memory-bounded, concurrency slot pre-claim, startup disk quota reconcile, complete retry idempotency, service worker v6 bump, strict 64-hex checksum, connectionId spoofing defense). |
